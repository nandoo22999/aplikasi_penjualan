              ...
              <div class="box box-info">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Tanggal Penjualan Barang </th>
                        <th>Nama Barang </th>
                        <th>Stok Barang (item) </th>
                        <th>Harga Barang </th>
                        <th>Jumlah Barang Terjual (item)</th>
                        <th>Total Harga </th>
                        <th>Delete</th>
                      </tr>
                    </thead>
              ...
              <div class="box box-info">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Jumlah Pesanan Barang </label>
                      <input type="number" class="form-control" id="itemterjual" name="itemterjual" placeholder="Jumlah Pesanan " required data-fv-notempty-message="Tidak boleh kosong">
                    </div>
