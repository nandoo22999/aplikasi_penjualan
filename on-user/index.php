    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>TOKO KRINTJI </span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>TOKO KELONTONG </b></span>
        </a>
      ...
      <footer class="main-footer">
        <div align="center" class="pull-center hidden-xs">
          <b><strong >Copyright &copy; 2022 <a href="http://www.kelontong.com">TOKO KELONTONG </a></strong></b>
        </div>
