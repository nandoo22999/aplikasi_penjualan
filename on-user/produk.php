...
<div class="content-wrapper">
        ...
        <h1> Data Barang </h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=produk&act=view">Data Barang</a></li>
            <li class="active"><a href="#">Tambah Data Barang</a></li>
             </ol>
        </section>
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="harga" name="harga" placeholder="Harga Kopi" required data-fv-notempty-message="Tidak boleh kosong">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Stok Barang </label>
                      <input type="number" class="form-control" id="stokproduk" name="stokproduk" placeholder="Stok Kopi" required data-fv-notempty-message="Tidak boleh kosong">
                    </div>
					 <div class="form-group">
              ...
              <div class="box box-info">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Harga Barang </label>
                      <input type="number" class="form-control" id="harga" name="harga" placeholder="Harga Kopi" value= "<?php echo $d['harga'];?>">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Stok Barang </label>
                      <input type="number" class="form-control" id="stokproduk" name="stokproduk" placeholder="Stok Kopi" value= "<?php echo $d['stokproduk'];?>">
                    </div>
					 <div class="form-group">
                      <label for="exampleInputEmail1">Satuan</label>
